...
public class WorktimeInterceptor implements MethodInterceptor {
	...
	public static final Logger logger = LoggerFactory.getLogger(WorktimeInterceptor.class);
	@Override
	public Object invoke(MethodInvocation arg0) throws Throwable {
		...
		logger.info(StringUtils.contactString(method, " paramValue = " + paramValue.toString(), " use time = ", (e - s) + "ms"));
		return result;
